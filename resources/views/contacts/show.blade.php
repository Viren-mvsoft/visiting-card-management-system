                ...
                <div class="flex items-start gap-5">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex flex-wrap items-center gap-3 mt-3">
                            ...
                            @endif
                            @if($contact->event)
                                <a href="{{ route('events.show', $contact->event) }}" class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-xs font-medium bg-primary-500/10 text-primary-400 border border-primary-500/20 hover:bg-primary-500/20 transition-all">
